...
$navItems = [
    ...
    ['icon'=>'<i class="bi bi-truck"></i>','label'=>'Suppliers','href'=>'suppliers.php','roles'=>['admin','supplier']],
    ['icon'=>'<i class="bi bi-receipt"></i>','label'=>'Purchase Orders','href'=>'purchase_orders.php','roles'=>['admin','supplier']],
    ['section'=>'Management'],
